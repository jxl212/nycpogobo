...
async def on_message(message):
	...
	txt=", ".join((name, "{}%".format(int(m['iv'])), str(level), "(f:{})".format(pokestats.spawn_per_hour(name)[1]), boro, neighborhood, str(is_raid), str(get_weather_boosted(message)), nycpokemap_link))
